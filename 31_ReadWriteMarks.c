...
//Program:Write & read student's grades/marks.
...
int main() {
	...
	FILE *fptr;
	int i;
	fptr=fopen("E:\\Cprograms\\MasroorShah_107_C_Programs_Repository031_\\Marks.txt","wb"); //Opening the file from the location.
	for (i=0;i<1;++i) {
		fflush(stdin);
	...
	fclose(fptr);
	fptr=fopen("E:\\Cprograms\\MasroorShah_107_C_Programs_Repository031_\\Marks.txt","rb");
